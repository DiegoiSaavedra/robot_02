...
class MotorControlGUI:
    def __init__(self, master):
        ...
        # --- Frame para ingresar la posición usando un slider ---
        self.angle_frame = ttk.LabelFrame(master, text="Posición en grados")
        self.angle_frame.pack(padx=10, pady=5, fill="x")
        
        # Se crea un slider de 0 a 180
        self.angle_slider = tk.Scale(self.angle_frame, from_=0, to=180, orient="horizontal", 
                                     label="Ángulo (0-180)", length=300)
        self.angle_slider.pack(side="left", padx=5, pady=5)
        ...
        # Se configura el widget de texto con fondo negro y letras verdes
    ...
    def start_motor(self):
        """Envía el ángulo seleccionado para iniciar el movimiento del motor."""
